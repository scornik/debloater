...
final class RsdLinkRule extends CoreFeatureRule {
	...
	protected function title(): string {
		return __( 'The page head advertises the XML-RPC endpoint', 'hakeemify-debloater' );
	}
	...
	protected function summary(): string {
		return __( 'Every page carries a Really Simple Discovery link pointing at xmlrpc.php.', 'hakeemify-debloater' );
	}
	...
	protected function evidenceLabel(): string {
		return __( 'RSD discovery link', 'hakeemify-debloater' );
	}
}
